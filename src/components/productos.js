...
import { todosLosProductos } from "../funciones/todosLosProductos";
...
const Productos = () => {
 ...
 useEffect(() => {
   todosLosProductos(setProductos);
 }, []);
   ...
   productosFiltrados = productos.filter((p) =>
    ...
    return (
      ...
      {window.scroll(0,0)}
       ...
       <div className="banner" id="todosPanel"></div>
      <div className="tituloBoton">
        <h1 className="letraSeccion">Todos los productos</h1>
      </div>
